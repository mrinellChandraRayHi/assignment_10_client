...
const AllArtandCraft = () => {
    ...
    return (
        <div>
            <div className="text-center bg-green-500 w-[100px] h-[100px] font-bold flex items-center justify-center text-7xl mx-auto rounded-full mt-16">{artAndCrafts.length}</div>
